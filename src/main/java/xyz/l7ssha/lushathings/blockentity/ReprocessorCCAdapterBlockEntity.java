...
public class ReprocessorCCAdapterBlockEntity extends BlockEntity {
    ...
    private ReprocessorControllerBlockEntity findController() {
        ...
        for (BlockPos checkPos : BlockPos.betweenClosed(worldPosition.offset(-2, -2, -2), worldPosition.offset(2, 2, 2))) {
            ...
            if (checkState.getBlock() instanceof ReprocessorControllerBlock) {
                if (checkState.getValue(ReprocessorMultiblock.MUTLIBLOCK_FORMED)) {
                    if (level.getBlockEntity(checkPos) instanceof ReprocessorControllerBlockEntity controller) {
                        return controller;
                    }
                }
            }
    ...
    public class ReprocessorPeripheral implements IPeripheral {
         ...
         * @return status string: "ok", "no_input_hatch", "no_output_hatch", "no_recipe", "no_energy", "output_full", or "not_formed"
         */
        @LuaFunction
         ...
         * @return status code: 0=ok, 1=no_input_hatch, 2=no_output_hatch, 3=no_recipe, 4=no_energy, 5=output_full, -1=not_formed
         */
        @LuaFunction
        ...
        public final boolean isProcessing() {
            ...
            return controller.data.get(2) == ReprocessorControllerBlockEntity.STATUS_OK && controller.data.get(0) > 0;
        }
        ...
        public final Map<String, Object> getInfo() {
            ...
            if (controller == null) {
                ...
                info.put("processing", statusCode == ReprocessorControllerBlockEntity.STATUS_OK && progress > 0);
            }
