...
public class ModEventBus {
        ...
        new LootTableProvider(
            ...
            List.of(
                new LootTableProvider.SubProviderEntry(
                    BlockLootTableProvider::new, LootContextParamSets.BLOCK)),
            lookupProvider));
  }
  ...
  public static void registerCapabilities(RegisterCapabilitiesEvent event) {
    ...
    event.registerBlockEntity(
        ...
        (be, context) -> be.getCombinedInventory());
    event.registerBlockEntity(
        Capabilities.EnergyStorage.BLOCK,
        lushathings.REPROCESSOR_ENERGY_INPUT_BLOCK_ENTITY.get(),
        (be, context) -> be.getEnergyStorage());
    event.registerBlockEntity(
        Capabilities.EnergyStorage.BLOCK,
        lushathings.ETERNAL_FIRE_SOURCE_RECOMBINATOR_BLOCK_ENTITY.get(),
        (be, context) -> ((EternalFireSourceRecombinatorBlockEntity) be).getEnergyStorage());
