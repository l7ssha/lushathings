...
public class ReprocessorHatchScreen extends AbstractContainerScreen<ReprocessorHatchMenu> {
  private static final ResourceLocation TEXTURE =
      ResourceLocation.fromNamespaceAndPath(
          lushathings.MODID, "textures/gui/reprocessor_hatch_gui.png");
  private net.minecraft.client.gui.components.Button autoButton;

  public ReprocessorHatchScreen(
      ReprocessorHatchMenu menu, Inventory playerInventory, Component title) {
  ...
  private Component getAutoButtonText() {
    ...
    Component typeComp =
        isPull
            ? Component.translatable("lushathings.screen.hatch.pull")
            : Component.translatable("lushathings.screen.hatch.push");
    Component stateComp =
        enabled
