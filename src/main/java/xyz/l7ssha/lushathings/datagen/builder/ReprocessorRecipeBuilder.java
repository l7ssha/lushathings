...
public class ReprocessorRecipeBuilder implements RecipeBuilder {
  ...
  public ReprocessorRecipeBuilder(
      ItemStack result, ItemStack result2, int craftingTime, int energyCost) {
    this.result = result;
  ...
  public static ReprocessorRecipeBuilder create(
      ItemStack result, int craftingTime, int energyCost) {
  ...
  public void save(RecipeOutput output, ResourceLocation id) {
    ...
    ReprocessorRecipe recipe =
        new ReprocessorRecipe(
            this.ingredients, this.result, this.result2, this.craftingTime, this.energyCost);
